export default function LogoCircle() {
  return (
    <span className='mb-8 mt-20 flex size-20 items-center justify-center rounded-full bg-white p-4 text-center shadow-sm '>
      <svg
        ...
        viewBox='0 0 32 32'
        className='euiIcon css-1l481du-euiIcon-xxl-isLoaded'
        role='img'
        data-icon-type='logoElastic'
        data-is-loaded='true'
        aria-hidden='true'
      >
        <path
